...
{
    // NB: this is a direct copy of https://github.com/RSuter/NJsonSchema/blob/master/src/NJsonSchema/DefaultTypeNameGenerator.cs
    //     added here purely to aid debugging
    /// <summary>Converts the last part of the full type name to upper case.</summary>
    public class MyDefaultTypeNameGenerator : ITypeNameGenerator
    {
